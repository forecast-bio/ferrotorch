...
impl NAdamConfig {
    ...
    /// Set the momentum decay for the mu schedule.
    #[must_use]
    pub fn with_momentum_decay(mut self, momentum_decay: f64) -> Self {
...
mod tests {
    ...
    fn test_nadam_state_dict_roundtrip() {
        ...
        let loaded = opt2
            .state_dict()
            .expect("nadam state_dict round-trip must succeed in test");
